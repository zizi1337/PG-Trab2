...
fun Canvas.interception (game : Game) : Game{
    ...
    val jogo = Game(game.nave, game.enemy.mapNotNull {if (it.x in xi-2..xf+2 && it.y in yi..yf) null else it},game.EndGame,game.points) // if spaceship shot and enemy shot intercects
